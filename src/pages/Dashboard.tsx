...
import { Plus, Search, Download, Eye, TrendingUp, FileText, Crown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 pt-24 pb-16">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <Link
            to="/analyze"
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-blue-500/20 text-sm self-start"
          >
